...
class EditLandPageState extends State<EditLandPage> {
  ...
  late TextEditingController _plaReceivedDateController;
  ...
  void initState() {
    ...
    _plaReceivedDateController = TextEditingController(
        text: widget.landPropertyData[DatabaseHelper.columnPlaReceivedDate] ??
            '');
    ...
    if (_selectedPropertyMunicipality != null && storedAppNumber != null) {
      List<String>? validAppNumbers =
          _applicationNumbersByMunicipality[_selectedPropertyMunicipality];
      if (validAppNumbers != null &&
          validAppNumbers.contains(storedAppNumber)) {
        _selectedApplicationNumber = storedAppNumber;
      } else {
        ...
        _selectedApplicationNumber =
            matchedBase != null && matchedBase.isNotEmpty ? matchedBase : null;
      }
    } else {
  ...
  Future<void> _saveLandProperty() async {
    if (_formKey.currentState!.validate()) {
      // Try retrieving the land property ID from both keys.
